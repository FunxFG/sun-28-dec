...
if response.status_code == 200:
    ...
    print()
    print("PNG:")
    print(f"https://tmp-generator-1.preview.emergentagent.com/api/downloads/file/{result['png_filename']}")
    print()
    print("PDF:")
    print(f"https://tmp-generator-1.preview.emergentagent.com/api/downloads/file/{result['pdf_filename']}")
    print()
